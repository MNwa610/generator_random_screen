...
Небольшое Express-приложение с API и статическим интерфейсом. Позволяет генерировать случайные цвета, применять их как фон страницы и сохранять свои варианты. Пример скриншота: `public/screenshots/preview.svg`.
